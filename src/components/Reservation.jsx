...
export default function Reservation(props) {
  ...
  return (
    ...
    <form className="resa-container" onSubmit={() => window.alert('Votre réservation est enregistrée :)')}>
      ...
      <textarea className="resa-text-area" {...register("claim")} placeholder="Entrez votre demande ici..." />
